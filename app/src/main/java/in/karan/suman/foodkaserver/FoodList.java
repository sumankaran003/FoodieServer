...
import in.karan.suman.foodkaserver.Model.Food;
import in.karan.suman.foodkaserver.ViewHolder.FoodViewHolder;
...
public class FoodList extends AppCompatActivity {
    ...
    private void showAddFoodDialog() {
        ...
        btnSelect=(Button)add_food_layout.findViewById(R.id.btnSelect);
        btnUpload=(Button)add_food_layout.findViewById(R.id.btnUpload);
